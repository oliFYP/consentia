  ...
  const clientTypes = [
    {
      ...
      title: "Tech Startups",
      description:
        "Fast-growing companies that need compliance without the complexity",
      features: [
        "Scalable solutions",
    ...
    },
    {
      ...
      description:
        "Creative teams managing client data who need expert guidance",
      features: [
    ...
    },
    {
      ...
      description:
        "Software businesses handling user data across multiple jurisdictions",
      features: [
    ...
    },
    {
      ...
      title: "E-commerce",
      description:
        "Online retailers processing customer data and payment information",
      features: [
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 max-w-md">
                ...
                <div className="text-center">
                  ...
                  <p className="text-blue-100">
                    Clear, reliable, and fast support — so that compliance
                    becomes a driver of trust, not a blocker to growth.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We partner with forward-thinking businesses across industries,
              helping them transform GDPR compliance from a challenge into a
              ...
              <div key={index} className="group relative">
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-gray-100">
                  ...
                  <div className="relative z-10">
                    <div
                      className={`bg-gradient-to-r ${client.gradient} p-4 rounded-2xl w-fit mb-6 text-white`}
                    >
                      {client.icon}
                    </div>
                    ...
                    <div className="space-y-3">
                      {client.features.map((feature, featureIndex) => (
                        ...
                        >
                          <div
                            className={`w-2 h-2 rounded-full bg-gradient-to-r ${client.gradient}`}
                          ></div>
          ...
          <div className="bg-white rounded-3xl p-12 shadow-xl">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                Transform your approach to data protection with our
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-2xl text-blue-600 font-semibold mb-8">
              We believe data protection should not be a burden but a strategic
              advantage.
            </p>
          </div>
